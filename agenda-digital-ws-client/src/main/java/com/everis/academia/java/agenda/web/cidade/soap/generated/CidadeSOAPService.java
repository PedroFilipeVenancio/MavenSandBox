 ...
 * 
 */
@WebServiceClient(name = "CidadeSOAPService", targetNamespace = "http://soap.cidade.web.agenda.java.academia.everis.com/", wsdlLocation = "http://localhost:8080/agenda-digital-web/soap/ClienteSOAP?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CIDADESOAPSERVICE_QNAME = new QName("http://soap.cidade.web.agenda.java.academia.everis.com/", "CidadeSOAPService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/agenda-digital-web/soap/ClienteSOAP?wsdl");
    ...
    public CidadeSOAP getCidadeSOAPPort() {
        return super.getPort(new QName("http://soap.cidade.web.agenda.java.academia.everis.com/", "CidadeSOAPPort"), CidadeSOAP.class);
    }
    ...
    public CidadeSOAP getCidadeSOAPPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.cidade.web.agenda.java.academia.everis.com/", "CidadeSOAPPort"), CidadeSOAP.class, features);
    }
